...
import src.optimizers.loss_function as loss_function
...
# Load data
train_data, test_data, classes = dataloader.data_load(config)
print(classes)
...
criterion = loss_function.get_loss(config)
...
writer.add_image('64_CIFAR_images', img_grid)
